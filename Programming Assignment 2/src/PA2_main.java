...
public class PA2_main {
		...
		try
		{
			...
			else if(args.length == 2)
			{
				if (args[0].equals("compress"))
				{
					...
					List<String> file_contents = PA2_main.readFile(to_compress);
	...
	public void pa2Test()
	{
		String[] file_array = {"/Users/philiplgelinas/233Rep_Philip/PA2/src/test.txt", "/Users/philiplgelinas/233Rep_Philip/PA2/src/savio.txt", "/Users/philiplgelinas/233Rep_Philip/PA2/src/kennedy.txt"};
	...
	public void pa2Test2() throws IOException
	{
		...
		System.out.println("second smallest: " + second_smallest + " (expected 6)");
		
		//TEST #2: huffman from tree test
		//PROVIDED: read contents of file into list of Strings
		String file_name = "/Users/philiplgelinas/233Rep_Philip/PA2/src/pa2test.txt";
